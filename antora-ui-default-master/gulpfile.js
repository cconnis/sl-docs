...
const bundleName = 'ui'
const buildDir = 'dist'  // Changed from 'build' to 'dist'
const previewSrcDir = 'preview-src'
const previewDestDir = 'public'
const srcDir = 'src'
const destDir = `${buildDir}/_`  // Output to 'dist/_' instead of 'public/_'
...
const cleanTask = createTask({
  ...
  call: task.remove(['dist', 'public']),  // Update 'build' to 'dist'
})
...
const bundlePackTask = createTask({
  ...
  call: task.pack(
    destDir,  // Pack from 'dist/_'
    buildDir,  // Output to 'dist'
    bundleName,
